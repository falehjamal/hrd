...
<x-page-header title="Buat Periode Gaji" subtitle="Generate draft payroll untuk bulan tertentu">
    <x-slot:actions>
    ...
    <div class="card-body">
        <form action="{{ route('payroll-periods.store') }}" method="POST">
            ...
            <div class="d-flex gap-2 mt-4">
                <button type="submit" class="btn btn-primary">Buat & Generate</button>
                <a href="{{ route('payroll-periods.index') }}" class="btn btn-outline-secondary">Batal</a>
            </div>
        </form>
    </div>
</div>
