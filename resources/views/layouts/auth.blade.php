<!DOCTYPE html>
<html lang="id" class="light-style customizer-hide hrd-app" dir="ltr" data-theme="theme-default" data-assets-path="{{ asset('sneat/') }}/" data-template="vertical-menu-template-free">
<head>
    <meta charset="utf-8" />
